					...
					<div className='pt-44 main-bg-accent pb-16'>
						...
						<div className='pt-4'>
							<div className='m-auto grid lg:grid-cols-3 w-10/12 lg:gap-y-10 grid-cols-1 gap-y-6'>
								<div style={{padding: '0.1rem'}} className='w-max bg-white m-auto shadow-2xl ease-out cursor-pointer hover:scale-110 duration-500'><img className="object-cover m-auto h-40 aspect-video" src="/Assets/Dubai/07.jpg" alt="" /></div>
