	...
	return (
		<>
			<div className='w-screen absolute top-32 main-bg-accent'>
				<div className='pt-10'>
					<h1 className='lg:block lg:px-44 text-2xl lg:text-4xl pb-20 accent-text-color lg:text-left text-center'>STORES - ABU DHABI</h1>
					<div className='h-7 w-screen bg-transparent lg:bg-white relative'>
						<div className='lg:mt-0 mt-10 text-white items-center flex flex-col justify-center text-center absolute h-40 w-full lg:w-10/12 bg-transparent lg:bg-gray-900 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2'>
							<h1 className='text-2xl'>ABU DHABI</h1>
					...
					<div className='pt-44 main-bg-accent pb-16'>
						<h1 className='text-center text-white text-2xl lg:text-4xl'>GALLERY</h1>
						<div className='pt-4'>
							<div className='m-auto grid lg:grid-cols-3 w-10/12 lg:gap-y-10 grid-cols-1 gap-y-6'>
								<div className='ease-out cursor-pointer hover:scale-110 duration-500 p-3 w-max bg-white m-auto shadow-2xl'><img className="m-auto h-40 aspect-video" src="/Assets/Dubai/01.jpg" alt="" /></div>
								<div className='ease-out cursor-pointer hover:scale-110 duration-500 p-3 w-max bg-white m-auto shadow-2xl'><img className="m-auto h-40 aspect-video" src="/Assets/Dubai/02.jpg" alt="" /></div>
								<div className='ease-out cursor-pointer hover:scale-110 duration-500 p-3 w-max bg-white m-auto shadow-2xl'><img className="m-auto h-40 aspect-video" src="/Assets/Dubai/03.jpg" alt="" /></div>
								<div className='ease-out cursor-pointer hover:scale-110 duration-500 p-3 w-max bg-white m-auto shadow-2xl'><img className="m-auto h-40 aspect-video" src="/Assets/Dubai/04.jpg" alt="" /></div>
								<div className='ease-out cursor-pointer hover:scale-110 duration-500 p-3 w-max bg-white m-auto shadow-2xl'><img className="m-auto h-40 aspect-video" src="/Assets/Dubai/05.jpg" alt="" /></div>
								<div className='ease-out cursor-pointer hover:scale-110 duration-500 p-3 w-max bg-white m-auto shadow-2xl'><img className="m-auto h-40 aspect-video" src="/Assets/Dubai/06.jpg" alt="" /></div>
							</div>
						</div>
					</div>
